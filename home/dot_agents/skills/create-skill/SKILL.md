...
1. **Gather requirements** - ask user about:
   - What task/domain does the skill cover and what is its scope?
     - (Global) Cross-project utility (saved in `<chezmoi_src_dir>/home/dot_agents/skills/`)
     - (Workspace) Project-specific logic (saved in `<project-root>/.agents/skills/`)
