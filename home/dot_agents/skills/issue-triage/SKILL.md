...
The maintainer invokes `/issue-triage` and describes what they want in natural language. Interpret the request and act. Examples:
...
4. **Grill (if needed).** If the issue needs fleshing out, run a `/grill-domain` session.
