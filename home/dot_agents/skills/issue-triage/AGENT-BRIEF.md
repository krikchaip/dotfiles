...
An agent brief is a structured comment posted on the project's issue tracker when it moves to `ready-for-agent`. It is the authoritative specification that an AFK agent will work from. The original issue body and discussion are context — the agent brief is the contract.
...
- **Good:** "When a user runs `/issue-triage` with no arguments, they should see a summary of issues needing attention"
...
- **Good:** "A query of the issue tracker returns issues that have been through initial classification"
