...
-- Vertical Scrolling
vim.keymap.set('n', '<M-j>', '<C-d>zz', { desc = 'Scroll half page down' })
vim.keymap.set('n', '<M-k>', '<C-u>zz', { desc = 'Scroll half page up' })
vim.keymap.set('n', '<M-S-j>', 'jzz', { desc = 'Scroll down' })
vim.keymap.set('n', '<M-S-k>', 'kzz', { desc = 'Scroll up' })
