...
--   callback = function()
--     vim.schedule(require('plugins.ui.trouble.utils').handle_quickfix_open)
--   end,
-- })
...
--     if vim.bo[ev.buf].buftype == 'quickfix' then vim.schedule(require('plugins.ui.trouble.utils').handle_quickfix_open) end
--   end,
-- })
