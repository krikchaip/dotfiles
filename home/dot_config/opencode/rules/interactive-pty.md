...
If a command is expected to take long (e.g. integration/e2e tests, heavy builds) or forever (e.g. dev servers, watch modes), run it in the background session using `pty_spawn`.
