---
name: crafting-rules
description: Use when creating or modifying OpenCode rules (.md files) that customize agent behavior. Trigger when user wants to create a rule, codify repeated instructions, persist guidance across sessions, or scope rules to specific files, prompts, environments, or workflows
---
...
- `<chezmoi_src_dir>/home/dot_config/opencode/rules/`: personal preferences you want across projects.
