...
Recompute the widget and full pane layout after adoption. Keep main-pane focus unchanged. If one child finishes during reload, process its terminal sidecar before rendering the first post-reload widget.