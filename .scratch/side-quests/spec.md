...
- Add concise parent system-prompt guidance that `subagent_type`, `inherit_context`, and `interactive` apply only to new launches and must be omitted on resume. Do not add this rule to the short `Agent` tool description.
