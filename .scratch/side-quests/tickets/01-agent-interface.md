...
- A sub-agent returns its completed side-quest handoff through an explicit side-quest completion declaration. The declaration supplies the final result and never embeds the full transcript.
